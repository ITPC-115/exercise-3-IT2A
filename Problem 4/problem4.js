...
const namee = window.prompt('Enter your name: ');
const iAge = Number(window.prompt('Enter your age: '));
const person = {name: namee, age: iAge};

for(let s = 2024; s < 2034; s++)
{   
    person[keyvalue]++;
    console.log(s +  `'${person.name}' ${person[keyvalue]}`);   
}
